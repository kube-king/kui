  ...
  template:
    ...
    spec:
      ...
      initContainers:
        ...
        - name: upgrade-ipam
          image: {{ .REGISTRY }}/calico:cni-{{ .VERSION }}
        ...
        - name: flexvol-driver
          image: {{ .REGISTRY }}/calico:pod2daemon-flexvol-{{ .VERSION }}
          volumeMounts:
      ...
      containers:
        ...
        # host.
        - name: calico-node
          image: {{ .REGISTRY }}/calico:node-{{ .VERSION }}
          ports:
            - name: http-metrics
              hostPort: 9091
              containerPort: 9091
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: calico-kube-controllers
          image: {{ .REGISTRY }}/calico:kube-controllers-{{ .VERSION }}
          env:
